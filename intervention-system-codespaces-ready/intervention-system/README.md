...
1. Click **Use this template** or push this repo to GitHub.
2. Open the repo in **Codespaces** (green `Code` button → *Create codespace on main*).
3. Wait for setup to finish (the devcontainer installs Python and your dependencies).
4. Run the app:
   - In VS Code: press **F5** and choose **Flask: run app.py**, or
   - Terminal: `source .venv/bin/activate && flask run --host 0.0.0.0 --port 5000`
5. A forwarding link to port **5000** will appear automatically. Click it to open the app.
